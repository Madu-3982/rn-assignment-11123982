  	...
  	return (
    		...
    		<View style={styles.homepage}>
      			<View style={styles.headlineParent}>
        				<Text style={styles.headline}>amofahwilliam18@gmail.com</Text>
        				<Text style={styles.headline1}>William Amofah</Text>
      			</View>
          ...
          <Text style={[styles.text, styles.textTypo]}>$170,00</Text>
        </View>
